...
public class ProductController {
	...
	public ModelAndView edit(ModelMap modelMap,@PathVariable("productId") Long productId) {
		...
		modelMap.addAttribute("message", "Products is not existed!");
	...
	public ResponseEntity<Resource> serveFile(@PathVariable String filename){
		Resource file = storageService.loadResoure(filename);
	...
	public ModelAndView saveOrUpdate(ModelMap model,
		...
		if(!dto.getImageFile().isEmpty()) {
			...
			entity.setImage(storageService.getStoriedFileName(dto.getImageFile(), uuString));
